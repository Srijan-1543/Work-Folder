...
test_df = pd.read_csv(r"D:\Software_Coding Files\Verzeo-Python with machine learning\test.csv")
train_df = pd.read_csv(r"D:\Software_Coding Files\Verzeo-Python with machine learning\train.csv")
